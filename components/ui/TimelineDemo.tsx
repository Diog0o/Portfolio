    ...
    },
    {
      ...
      content: (
        <div>
          ...
          <p className="text-neutral-800 dark:text-neutral-200 text-md md:text-lg font-normal mb-8">
            Worked on an outsourcing project through Junitec for Brands&Ninjas,
            developing a comprehensive full-stack mobile application. Joined a
            team of 4 developers, using JIRA for project management.
          </p>
          <div className="grid grid-cols-2 gap-4">
            <Image
              src="/brands.png"
